...
import com.guluwa.gulumusicpro.service.notification.PlayingNotification;
import com.guluwa.gulumusicpro.service.notification.PlayingNotificationImpl24;
import com.guluwa.gulumusicpro.service.notification.PlayingNotificationOreo;
import com.guluwa.gulumusicpro.utils.AppUtils;
import com.guluwa.gulumusicpro.utils.PreferenceUtil;
import com.guluwa.gulumusicpro.utils.StopWatch;
import com.guluwa.gulumusicpro.views.appwidgets.AppWidgetClassic;
...
import static com.guluwa.gulumusicpro.manage.Contacts.*;
...
//            }
    ...
    private static String getTrackUri(@NonNull Song song) {
        return AppUtils.INSTANCE.getSongFileUri(song.getId()).toString();
    }
    ...
    public void onCreate() {
        ...
        sendBroadcast(new Intent("com.guluwa.gulumusicpro.RETRO_MUSIC_SERVICE_CREATED"));
    ...
    public void onDestroy() {
        ...
        sendBroadcast(new Intent("com.guluwa.gulumusicpro.RETRO_MUSIC_MUSIC_SERVICE_DESTROYED"));
    }
    ...
    public void openQueue(@Nullable final ArrayList<Song> playingQueue, final int startPosition, final boolean startPlaying) {
        if (playingQueue != null && !playingQueue.isEmpty() && startPosition >= 0 && startPosition < playingQueue.size()) {
            ...
            if (shuffleMode == SHUFFLE_MODE_SHUFFLE) {
                AppUtils.INSTANCE.makeShuffleList(this.playingQueue, startPosition);
                position = 0;
            }
            if (startPlaying) {
                playSongAt(position);
    ...
    public void setShuffleMode(final int shuffleMode) {
        ...
        switch (shuffleMode) {
            case SHUFFLE_MODE_SHUFFLE:
                ...
                AppUtils.INSTANCE.makeShuffleList(this.getPlayingQueue(), getPosition());
                position = 0;
                break;
